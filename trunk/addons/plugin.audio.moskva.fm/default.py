...
def Station(st,thumb="",title="",so=False):
	#"http://185.17.30.41/stream/4000/1391416878?format=flv"
	#http://185.17.30.80/stream/4007/1391429001?format=flv
	link='http://185.17.30.80/stream/'+st+'/0?format=mp3'#flv
