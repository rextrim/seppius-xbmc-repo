...
def formtext(http):
	...
	#http=http.replace('           ',"").replace('          ',"").replace('         ',"").replace('        ',"").replace('       ',"").replace('      ',"").replace('     ',"").replace('    ',"").replace('   ',"").replace('  '," ").replace(' <td',"<td").replace(' </td',"</td")
	http=http.replace('<img src="/images/filesearch/magnet.png"> </a> </td> <td> <a target=_blank href=',chr(10)+"flag1 ['http://krasfs.ru/")#разделить
